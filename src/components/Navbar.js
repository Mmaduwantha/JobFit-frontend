    ...
    <header className="mx-1 mt-1 mb-5 px-6 h-18 bg-gray-900 shadow-md rounded-md">
        <div className="container mx-auto flex justify-between items-baseline py-1 px-5">
          ...
          <nav className=" ml-4 flex space-x-16">
            <a href="#home" className="text-blue-600 hover:text-blue-600 transition-colors duration-500 ease-in-out">Home</a>
            <a href="#account" className="hover:text-blue-600 transition-colors duration-500 ease-in-out">Account</a>
            <a href="#about" className="hover:text-blue-600 transition-colors duration-500 ease-in-out">About</a>
          </nav>
